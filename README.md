...
> **Tip:** expand the section below to copy the script in one click without opening the file.

<details>
<summary>📋 Show full script (click to expand → copy button appears)</summary>
